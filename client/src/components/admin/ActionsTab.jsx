...
import { api, cardCls, btnPrimary, btnSecondary, btnDanger } from "./adminShared.js";
...
export default function ActionsTab() {
  ...
  const downloadDb = () => { window.location.href = "/api/admin/maintenance/download-db"; };
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        <SystemCard appInfo={appInfo} onRestart={() => setServiceAction("restart")} onStop={() => setServiceAction("stop")} />
      </div>
      ...
      <ConfirmModal
        ...
        message={pendingFile ? `Replace the current database with "${pendingFile.name}"? This overwrites all existing data and cannot be undone.` : ""}
