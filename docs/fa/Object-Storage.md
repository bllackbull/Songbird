...
| `local` | **پردازش کاملاً محلی.** workerهای رسانه ای سرور محلی (FFmpeg / BullMQ) را مجبور میکند تمام فایل های آپلودشده را پردازش کنند. |
