...
| گزینه | توضیح |
|---|---|
| SQLite (پیشفرض) | پایگاه داده SQLite درون حافظه ای با ذخیره سازی پایدار روی دیسک (`better-sqlite3`). مناسب برای نمونه های کوچک تا متوسط. |
| PostgreSQL | موتور پایگاه داده خارجی PostgreSQL. توصیه شده برای نمونه های بزرگتر (بیش از ۵۰۰ کاربر). آدرس هاست، پورت، نام پایگاه داده، نام کاربری و رمز عبور را میپرسد. |
