...
Songbird برای به‌روزرسانی‌های realtime (پیام‌ها، حضور و تایپ) از WebSocket استفاده می‌کند و از SSE به‌عنوان جریان جایگزین بهره می‌برد. هر دو به یک اتصال HTTP/WebSocket پایدار نیاز دارند که باز بماند؛ حالت حضور کاربر بر اساس اتصال زنده تعیین می‌شود. برخی پیکربندی‌های CDN اتصالات بی‌کار یا طولانی‌مدت را می‌بندند.
