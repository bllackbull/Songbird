...
export const SETTING_DEFS = [
  ...
  // ── Object storage & media worker (new since 0.12.0) ───────────────────────
  {
    key: "STORAGE_EXPIRES_IN",
    type: TYPE_INT,
    label: "Presigned URL expiry",
    description: "Seconds presigned upload/download URLs remain valid. (s)",
    group: "storage",
    envKey: "STORAGE_EXPIRES_IN",
    defaultVal: 3600,
    min: 60,
    max: 604800,
    restart: true, // S3 client is constructed once at startup
  },
  {
    key: "STORAGE_PROXY_URL",
    type: TYPE_STRING,
    label: "Object storage proxy",
    description: "HTTPS proxy URL for S3-compatible storage requests.",
    group: "proxy",
    envKey: "STORAGE_PROXY_URL",
    defaultVal: "",
    restart: true, // baked into the S3 client at startup
    nullable: true,
  },
  {
    key: "STORAGE_AUTO_CORS",
    type: TYPE_BOOL,
    label: "Auto-configure bucket CORS",
    description: "Automatically configure bucket CORS for browser uploads.",
    group: "storage",
    envKey: "STORAGE_AUTO_CORS",
    defaultVal: false,
    restart: true,
  },
  {
    key: "WORKER_URL",
    type: TYPE_STRING,
    label: "External media worker URL",
    description:
      "External worker for video transcoding (e.g. https://worker.example.com). Empty = local worker.",
    group: "storage",
    envKey: ["WORKER_URL", "MEDIA_WORKER_URL"],
    defaultVal: "",
    nullable: true, // applied per-request; no restart needed
  },
  {
    key: "STORAGE_PROCESSING_TIMEOUT_MS",
    type: TYPE_INT,
    label: "Worker fallback timeout",
    description:
      "Milliseconds before the local worker handles media in auto mode. (ms)",
    group: "storage",
    envKey: "STORAGE_PROCESSING_TIMEOUT_MS",
    defaultVal: 120000,
    min: 1000,
    max: 600000,
  },

  // ── Realtime WebSocket gateway (new since 0.12.0) ──────────────────────────
  {
    key: "WS_HEARTBEAT_INTERVAL_MS",
    type: TYPE_INT,
    label: "WS heartbeat interval",
    description: "Milliseconds between WebSocket heartbeat pings. (ms)",
    group: "realtime",
    envKey: "WS_HEARTBEAT_INTERVAL_MS",
    defaultVal: 30000,
    min: 1000,
    max: 300000,
    restart: true, // gateway timers are wired once at startup
  },
  {
    key: "WS_HEARTBEAT_TIMEOUT_MS",
    type: TYPE_INT,
    label: "WS heartbeat timeout",
    description:
      "Milliseconds to wait for a pong before closing the socket. (ms)",
    group: "realtime",
    envKey: "WS_HEARTBEAT_TIMEOUT_MS",
    defaultVal: 10000,
    min: 1000,
    max: 120000,
    restart: true,
  ...
  // ── Client behavior extensions (offline-first queue, health, search) ───────
  {
    key: "CHAT_LIST_REFRESH_INTERVAL",
    type: TYPE_INT,
    label: "Chat list refresh",
    description: "Milliseconds between chat list refreshes. (ms)",
    group: "client",
    envKey: "CHAT_LIST_REFRESH_INTERVAL",
    defaultVal: 20000,
    min: 1000,
    max: 300000,
  },
  {
    key: "CHAT_HEALTH_CHECK_INTERVAL",
    type: TYPE_INT,
    label: "Health check interval",
    description: "Milliseconds between connection health checks. (ms)",
    group: "client",
    envKey: "CHAT_HEALTH_CHECK_INTERVAL",
    defaultVal: 10000,
    min: 1000,
    max: 120000,
  },
  {
    key: "CHAT_SSE_RECONNECT_DELAY",
    type: TYPE_INT,
    label: "SSE reconnect delay",
    description: "Milliseconds to wait before SSE reconnect. (ms)",
    group: "client",
    envKey: "CHAT_SSE_RECONNECT_DELAY",
    defaultVal: 2000,
    min: 250,
    max: 30000,
  },
  {
    key: "CHAT_SEARCH_MAX_RESULTS",
    type: TYPE_INT,
    label: "Search results limit",
    description: "Maximum search results to return.",
    group: "client",
    envKey: "CHAT_SEARCH_MAX_RESULTS",
    defaultVal: 5,
    min: 1,
    max: 50,
  },
  {
    key: "CHAT_PENDING_TEXT_TIMEOUT",
    type: TYPE_INT,
    label: "Pending text timeout",
    description: "Milliseconds before a pending text message times out. (ms)",
    group: "client",
    envKey: "CHAT_PENDING_TEXT_TIMEOUT",
    defaultVal: 300000,
    min: 1000,
    max: 3600000,
  },
  {
    key: "CHAT_PENDING_FILE_TIMEOUT",
    type: TYPE_INT,
    label: "Pending file timeout",
    description: "Milliseconds before a pending file message times out. (ms)",
    group: "client",
    envKey: "CHAT_PENDING_FILE_TIMEOUT",
    defaultVal: 1200000,
    min: 1000,
    max: 7200000,
  },
  {
    key: "CHAT_PENDING_RETRY_INTERVAL",
    type: TYPE_INT,
    label: "Pending retry interval",
    description: "Milliseconds between pending message retries. (ms)",
    group: "client",
    envKey: "CHAT_PENDING_RETRY_INTERVAL",
    defaultVal: 4000,
    min: 250,
    max: 60000,
  },
  {
    key: "CHAT_PENDING_STATUS_CHECK_INTERVAL",
    type: TYPE_INT,
    label: "Pending status check",
    description: "Milliseconds between pending status checks. (ms)",
    group: "client",
    envKey: "CHAT_PENDING_STATUS_CHECK_INTERVAL",
    defaultVal: 1000,
    min: 250,
    max: 10000,
  },
